...
export default function onload() {
    ...
    // init the video
    if (!me.video.init(800, 600, {parent : "screen", scaleMethod : "flex", renderer : me.video.AUTO, preferWebGL1 : false, subPixel : false })) {
    ...
    me.loader.preload(resources, () => {
        ...
        me.pool.register("BulletEntity", BulletEntity, true)
